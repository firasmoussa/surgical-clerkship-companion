...
const QUESTIONS: Question[] = [
  ...
  { id: "p2", level: 1, question: "How do you reliably find the appendix laparoscopically?", answer: "Follow the taenia coli toward their convergence at the appendiceal base. This landmark helps locate an appendix whose tip lies in a variable position." },
  { id: "p3", level: 1, question: "What does a retrocecal appendix mean for identification?", answer: "The appendix lies behind the cecum. Its position can make exposure more difficult; cecal mobilization may be needed.", pearl: "Reported frequencies vary by population and study. Learn the relationship rather than a universal percentage." },
  { id: "p4", level: 1, question: "What are the classic CT findings of acute appendicitis?", answer: "Appendiceal enlargement, wall thickening, and surrounding inflammatory fat stranding support the diagnosis; an appendicolith may be present. Diameter alone is not diagnostic." },
  { id: "p5", level: 1, question: "What antibiotics do you give preoperatively for appendicitis?", answer: "Provide enteric gram-negative and anaerobic coverage. For uncomplicated appendectomy prophylaxis, options include cefoxitin or cefazolin plus metronidazole. Complicated infection requires a treatment regimen chosen for severity, allergies, and local resistance." },
  { id: "p6", level: 2, question: "What is the Alvarado score and what is its role?", answer: "A score based on pain migration, anorexia, nausea/vomiting, RLQ tenderness, rebound, fever, leukocytosis, and neutrophil left shift. It supports risk assessment but should not alone confirm appendicitis in adults." },
