const complications = [
  ...
  { complication: "Port-site hernia", timeframe: "Weeks-months", mechanism: "Risk increases at larger trocar sites, particularly the umbilicus", presentation: "Bulge or pain at port site; may present with bowel obstruction", management: "Surgical assessment; urgent evaluation for obstruction or suspected strangulation" },
  ...
  { complication: "Incidental appendiceal NET", timeframe: "Pathology result", mechanism: "Incidental neuroendocrine tumor on specimen pathology", presentation: "Often an incidental finding; review tumor size, grade, invasion, and margins", management: "Specialist assessment; right hemicolectomy for tumors >2 cm. Smaller tumors require risk-based assessment." },
];
