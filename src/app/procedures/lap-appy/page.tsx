    ...
    <>
      <section className="pt-8">
        ...
        <div className="mt-6 grid gap-5">
          ...
          <div>
            <div className="text-[14px] font-medium text-ink">Critical Concept -- Identifying the Appendix</div>
            <div className="mt-2 rounded-md border-l-[3px] border-ochre bg-surface p-3 text-[14px] text-secondary leading-relaxed">
